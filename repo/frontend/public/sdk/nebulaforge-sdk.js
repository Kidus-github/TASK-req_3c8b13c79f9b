(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.NebulaForge = {}));
...
void main() {
  ...
  const KNOWN_LAYERS = ["stars", "highlights", "drawing"];
  function embed(element, config) {
    return new StarMapSDKInstance(element, config);
  }
  class StarMapSDKInstance {
    constructor(element, config) {
      __publicField(this, "renderer");
      __publicField(this, "scene");
      __publicField(this, "camera");
      __publicField(this, "controls", null);
      __publicField(this, "starMesh", null);
      ...
      __publicField(this, "layerGroups", /* @__PURE__ */ new Map());
      __publicField(this, "layerVisibility", /* @__PURE__ */ new Map());
      // Drawing lifecycle state
      __publicField(this, "drawingMode", null);
      __publicField(this, "drawPoints", []);
      __publicField(this, "drawObjects", []);
      __publicField(this, "drawingGround", new Plane(new Vector3(0, 1, 0), 0));
      __publicField(this, "onCanvasClick");
      ...
      this.scene.background = new Color(config.background ?? "#0a0a1e");
    ...
    clearDrawingObjects() {
      ...
      for (const obj of this.drawObjects) {
        ...
        (_a = geo == null ? void 0 : geo.dispose) == null ? void 0 : _a.call(geo);
        if (Array.isArray(mat)) mat.forEach((m) => {
          var _a2;
          return (_a2 = m.dispose) == null ? void 0 : _a2.call(m);
        });
        else (_b = mat == null ? void 0 : mat.dispose) == null ? void 0 : _b.call(mat);
      }
      this.drawObjects = [];
    }
    renderDrawingPreview() {
      ...
      const pointGeo = new SphereGeometry(0.2, 8, 6);
      const pointMat = new MeshBasicMaterial({ color: 16436245 });
      for (const p of this.drawPoints) {
        const m = new Mesh(pointGeo, pointMat);
      ...
      if (this.drawingMode === "line" && this.drawPoints.length >= 2) {
        const lineGeo = new BufferGeometry().setFromPoints(
          this.drawPoints.map((p) => new Vector3(p.x, p.y, p.z))
        );
        const lineMat = new LineBasicMaterial({ color: 2282478 });
        const line = new Line(lineGeo, lineMat);
        group.add(line);
        this.drawObjects.push(line);
      }
      if (this.drawingMode === "polygon" && this.drawPoints.length >= 3) {
        const pts = this.drawPoints.map((p) => new Vector3(p.x, p.y, p.z));
        pts.push(pts[0].clone());
        const polyGeo = new BufferGeometry().setFromPoints(pts);
        const polyMat = new LineBasicMaterial({ color: 10741301 });
        const line = new LineLoop(polyGeo, polyMat);
        group.add(line);
        this.drawObjects.push(line);
      }
    ...
    updateStars(stars) {
      ...
      const geometry = new SphereGeometry(0.15, 8, 6);
      const material = new MeshStandardMaterial({ emissive: "#ffffff", emissiveIntensity: 0.3 });
      this.starMesh = new InstancedMesh(geometry, material, stars.length);
    ...
    stopDrawing() {
      ...
      const result = { mode, points, measurement };
    ...
    destroy() {
      ...
      (_b = this.starMesh) == null ? void 0 : _b.dispose();
  ...
  if (typeof window !== "undefined") {
    window.NebulaForge = { embed };
  }
  exports2.KNOWN_LAYERS = KNOWN_LAYERS;
  exports2.embed = embed;
  Object.defineProperty(exports2, Symbol.toStringTag, { value: "Module" });
}));
//# sourceMappingURL=nebulaforge-sdk.js.map
